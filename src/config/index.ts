...
export const CLIENT_CONFIG: ClientConfig = authType === "pairing"
	? {
		...
		autoRead: parseBoolean(process.env['CLIENT_AUTO_READ'], false),
		autoOnline: parseBoolean(process.env['CLIENT_AUTO_ONLINE'], false),
		autoPresence: parseBoolean(process.env['CLIENT_AUTO_PRESENCE'], true),
		autoRejectCall: parseBoolean(process.env['CLIENT_AUTO_REJECT_CALL'], false),
